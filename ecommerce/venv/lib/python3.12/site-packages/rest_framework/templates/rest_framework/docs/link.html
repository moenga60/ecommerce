...
<div class="row coredocs-link">
  <div class="col-md-6 docs-content">
    ...
    <h3
      id="{{ section_key }}-{{ link_key|slugify }}"
      class="coredocs-link-title"
    >
    ...
    <table class="parameters table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            {% if field.schema.description %}{{ field.schema.description|safe
            }}{% endif %}
          </td>
        </tr>
        {% endfor %}
    ...
    <h4>Request Body</h4>
    <p>
      The request body should be <code>"{{ link.encoding }}"</code> encoded, and
    ...
    <h4>Request Body</h4>
    <p>
      The request body should be a <code>"{{ link.encoding }}"</code> encoded
